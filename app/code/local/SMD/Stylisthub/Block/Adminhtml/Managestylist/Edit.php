 ...
 *
 */
class SMD_Stylisthub_Block_Adminhtml_Managestylist_Edit extends Mage_Adminhtml_Block_Widget_Form_Container {
    ...
    public function getHeaderText() {
        ...
        if (!empty($stylist_title)) {
            return $this->__('Commission Details of ' . $stylist_title);
        } else {
