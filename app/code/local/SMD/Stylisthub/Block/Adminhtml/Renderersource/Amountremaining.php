...
/**
 * Render the Amount remaining from admin to stylist
 */
class SMD_Stylisthub_Block_Adminhtml_Renderersource_Amountremaining extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Abstract {
