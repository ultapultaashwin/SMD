 ...
 */
class SMD_Stylisthub_Block_Adminhtml_Order extends Mage_Adminhtml_Block_Widget_Grid_Container {
    ...
    public function __construct() {
        ...
        $this->_headerText = Mage::helper('stylisthub')->__('Orders of ' . $stylist_title);
