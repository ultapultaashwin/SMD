...
class SMD_Stylisthub_Block_Adminhtml_Commission extends Mage_Adminhtml_Block_Widget_Grid_Container {
     ...
     *
     * Return stylist commission as array
     * @return array
     */
    public function __construct() {
        $this->_controller = 'adminhtml_commission';
        $this->_blockGroup = 'stylisthub';
        $this->_headerText = Mage::helper('stylisthub')->__('Payments');
